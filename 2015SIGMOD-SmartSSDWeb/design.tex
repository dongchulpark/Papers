...
\textbf{Step S5: Compute similarity and rank}. After the aforementioned list operations are completed, we can get a list of qualified documents. %Lucene assumes the results are small enough to fit into main memory.
